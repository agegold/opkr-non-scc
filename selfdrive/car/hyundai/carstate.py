...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp2, cp_cam):
    ...
    self.acc_active = self.current_cruise_speed > 0
    ...
    ret.cruiseState.speed = self.current_cruise_speed
    ...
    # autoresume features
    ret.cruiseState.possibly_reenable_cruise = False
    if ret.brakePressed or ret.gasPressed or self.clu_Vanz < 20:
      ...
      ret.cruiseState.possibly_reenable_cruise = True 
